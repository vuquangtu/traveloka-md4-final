...
function FlightHeader() {
  ...
  useEffect(() => {
    ...
    listDate.forEach((date, index) => {
      if (date.toISOString() === searchParams.startDate) {
        handleClick(index);
      }
    });
          ...
          <div className="flex flex-col">
            <div className="" style={{ width: "100%" }}>
              ...
              >
                ...
                >
                  <div
                    className="w-5/6 flex justify-between items-center ml-5"
                    style={{
                  ...
                  <div
                    className="self-center h-full w-20 text-semibold justify-self-end border border-solid rounded-lg flex justify-center items-center transition-all duration-300 ease-in-out :hover:bg-sky-500  :visited:bg-sky-500 :active:bg-sky-500 :focus:bg-sky-500 hover:cursor-pointer"
